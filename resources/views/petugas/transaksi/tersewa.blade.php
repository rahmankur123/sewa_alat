                ...
                <tr class="border-t hover:bg-slate-50 transition duration-200">
                    ...
                    <td class="px-4 py-3 text-center space-x-1">
                        ...
                        <form action="{{ route('petugas.transaksi.hapus',$d->id) }}" method="POST" class="inline"
                            ...
                            @csrf
                            @method('DELETE')
                            <button class="px-3 py-1 text-xs bg-red-500 text-white rounded-md hover:bg-red-600 transition">
                                Hapus
                            </button>
                        </form>
                        ...
                        <form action="{{ route('petugas.transaksi.diambil',$d->id) }}" method="POST" class="inline">
                            @csrf
                            <button class="px-3 py-1 text-xs bg-emerald-500 text-white rounded-md hover:bg-emerald-600 transition">
                                Diambil
                            </button>
                        </form>
